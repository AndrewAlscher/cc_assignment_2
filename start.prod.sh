...
apply_kubectl basic_services/api/image_api/prod/03-image-api-backend-config.prod.yaml
apply_kubectl basic_services/api/image_api/prod/02-image-api-ingress.prod.yaml
